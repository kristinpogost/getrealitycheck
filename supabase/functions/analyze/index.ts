...
- reality_check: a grounded, universal emotional truth — a short thought that lingers. MAX 1-2 short sentences. MUST NOT mention the person's name, specific events, or anything from the user's story. MUST NOT describe behavior, intentions, or this particular situation. MUST NOT repeat anything from dynamic / hidden_signals / intentions / meaning. Forbidden: "Jakobi käitumine näitab…", "Tema avatud lähenemine tähendab…", "Tema huvi sinu vastu…", "See kohtumine viitab…", any "Tema/Ta…" opening, any reference to a specific moment. Write a universal human realization that could apply beyond this case but feels exactly right here. Good: "Mugavus tekib sageli enne suuri sõnu." / "Ehtne huvi jätab ruumi ka vaikusele." / "Turvaline suhtlus ei vaja pidevat tõestamist." / "Kõige loomulikumad sidemed ei teki tavaliselt kiirustades." / "Päris huvi paistab sageli välja väikestes järjepidevates hetkedes." / "Emotsionaalne lähedus kasvab tihti märkamatult."
